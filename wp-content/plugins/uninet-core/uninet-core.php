...
define('UNINET_CORE_VERSION', '0.5.0');
...
$uninet_core_files = [
    ...
    'includes/Contact/InquiryPostType.php',
    'includes/Contact/Form.php',
    'includes/Setup/SitePages.php',
    'includes/Quote/RequestPostType.php',
    'includes/Quote/Builder.php',
